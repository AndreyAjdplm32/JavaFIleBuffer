...
public class Main {
    public static void main(String[] args) {
        ...
        String[] address = {"C://Games", "C://Games/src", "C://Games/res"};
        String[] way = {"C://Games/savegames/save1.dat", "C://Games/savegames/save2.dat", "C://Games/savegames/save3.dat"};
        ...
        for (String file : FileName) {
            File myFile = new File("C://Games/src/main", file);
            try {
        ...
        File myFile = new File("C://Games/temp", "temp.txt");
        try {
            if (myFile.createNewFile())
